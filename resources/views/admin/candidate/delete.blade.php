<div class="modal fade" id="modal_delete-{{ $candidate->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y pt-10 pb-10">
                ...
                <div class="text-center">
                    <form class="form" action="{{ route('admin.candidate.destroy', $candidate->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
